package com.review.test.common.adapter;
...
public class SpinnerAdapter<K, V> extends BaseAdapter implements Filterable {
     ...
     * @param flags
     */
    public SpinnerAdapter(Context context, int resource, int flags) {
     ...
     * @param flags
     */
    public SpinnerAdapter(Context context, int resource, int textViewResourceId, int flags) {
     ...
     */
    public SpinnerAdapter(Context context, int resource, LinkedHashMap<K, V> mapData) {
     ...
     * @param flags
     */
    public SpinnerAdapter(Context context, int resource, LinkedHashMap<K, V> mapData, int flags) {
     ...
     * @param mapData  The LinkedHashMap to use as the data source
     */
    public SpinnerAdapter(Context context, int resource, int textViewResourceId, LinkedHashMap<K, V> mapData) {
     ...
     * @param flags
     */
    public SpinnerAdapter(Context context, int resource, int textViewResourceId, LinkedHashMap<K, V> mapData, int flags) {
